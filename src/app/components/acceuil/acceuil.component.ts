...
export class AcceuilComponent  implements AfterViewInit {
  ...
  Notre site vous permet de trouver facilement le logement qui correspond à vos attentes. Profitez d’un accès à toutes les options de réservation en toute simplicité.
  Pour effectuer une réservation, veuillez cliquer sur le bouton Réserver.
  `;
